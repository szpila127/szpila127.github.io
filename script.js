$(document).ready(function() {
  const apiRoot = 'https://still-waters-18400.herokuapp.com/v1/';
  const trelloApiRoot = 'https://still-waters-18400.herokuapp.com/v1/trello/';
